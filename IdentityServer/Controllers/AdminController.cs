    ...
    public class AdminController : Controller
    {
        ...
        public async Task<JsonResult> CreateClient(ClientViewModel clientViewModel)
        {
            try
            {
                ...
                { new ClientPostLogoutRedirectUri { PostLogoutRedirectUri = string.IsNullOrEmpty(clientViewModel.ClientPostRedirectUri) ? clientViewModel.ClientRedirectUri : clientViewModel.ClientPostRedirectUri } };
